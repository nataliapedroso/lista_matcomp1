# -*- coding: utf-8 -*-
"""
Created on Tue May 26 17:02:44 2020

@author: nataliapedroso
"""

# Questão 6.1 usando a questão 3
# Construindo os espaços de parâmetro
...
alpha=d.filter(like=str(8192),axis=0)["Alpha"]
beta=d.filter(like=str(8192),axis=0)["Beta"]
legend=str(8192)
